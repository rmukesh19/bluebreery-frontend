  ...
  return (
    <div className="add-product-container">
      ...
      <div className="page-header" style={{
        ...
        <h2 style={{ fontSize: '18px', fontWeight: '700', color: '#0A2342' }}>Add New Product</h2>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '50px' }}>
        <button 
          ...
          disabled={loading}
          style={{ background: '#22c55e', color: '#fff', padding: '12px 40px', borderRadius: '4px', fontSize: '15px' }}
        >
